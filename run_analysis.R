...
setwd("/Users/mestherlv/Dropbox/Tesis/curso_R/curso2/UCI HAR Dataset/test")
a=read.table(file="subject_test.txt")
names(a)="subject"
x=read.table(file="X_test.txt")
names(x)=paste("x",seq(1:ncol(x)),sep="")
y=read.table(file="Y_test.txt")
names(y)="y"
data=data.frame(a,x,y)
setwd("/Users/mestherlv/Dropbox/Tesis/curso_R/curso2/UCI HAR Dataset/test/Inertial Signals")
data1=read.table("body_acc_x_test.txt")
names(data1)=paste("body_acc_x",seq(1:ncol(data1)),sep="")
data2=read.table("body_acc_y_test.txt")
names(data2)=paste("body_acc_y",seq(1:ncol(data2)),sep="")
data3=read.table("body_acc_z_test.txt")
names(data3)=paste("body_acc_z",seq(1:ncol(data3)),sep="")

data4=read.table("body_gyro_x_test.txt")
names(data4)=paste("body_gyro_x",seq(1:ncol(data4)),sep="")
data5=read.table("body_gyro_y_test.txt")
names(data5)=paste("body_gyro_y",seq(1:ncol(data5)),sep="")
data6=read.table("body_gyro_z_test.txt")
names(data6)=paste("body_gyro_z",seq(1:ncol(data6)),sep="")

data7=read.table("total_acc_x_test.txt")
names(data7)=paste("total_acc_x",seq(1:ncol(data7)),sep="")
data8=read.table("total_acc_y_test.txt")
names(data8)=paste("total_acc_y",seq(1:ncol(data8)),sep="")
data9=read.table("total_acc_z_test.txt")
...
setwd("/Users/mestherlv/Dropbox/Tesis/curso_R/curso2/UCI HAR Dataset/train")
a=read.table(file="subject_train.txt")
names(a)="subject"
x=read.table(file="X_train.txt")
names(x)=paste("x",seq(1:ncol(x)),sep="")
y=read.table(file="Y_train.txt")
names(y)="y"
datan=data.frame(a,x,y)
setwd("/Users/mestherlv/Dropbox/Tesis/curso_R/curso2/UCI HAR Dataset/train/Inertial Signals")
data1=read.table("body_acc_x_train.txt")
names(data1)=paste("body_acc_x",seq(1:ncol(data1)),sep="")
data2=read.table("body_acc_y_train.txt")
names(data2)=paste("body_acc_y",seq(1:ncol(data2)),sep="")
data3=read.table("body_acc_z_train.txt")
names(data3)=paste("body_acc_z",seq(1:ncol(data3)),sep="")

data4=read.table("body_gyro_x_train.txt")
names(data4)=paste("body_gyro_x",seq(1:ncol(data4)),sep="")
data5=read.table("body_gyro_y_train.txt")
names(data5)=paste("body_gyro_y",seq(1:ncol(data5)),sep="")
data6=read.table("body_gyro_z_train.txt")
names(data6)=paste("body_gyro_z",seq(1:ncol(data6)),sep="")

data7=read.table("total_acc_x_train.txt")
names(data7)=paste("total_acc_x",seq(1:ncol(data7)),sep="")
data8=read.table("total_acc_y_train.txt")
names(data8)=paste("total_acc_y",seq(1:ncol(data8)),sep="")
data9=read.table("total_acc_z_train.txt")
names(data9)=paste("total_acc_z",seq(1:ncol(data9)),sep="")
